...
const INITIAL_BARBERS = [
  {
    ...
    barbershop_id: DEFAULT_BARBERSHOP_ID,
    name: "Marcos Almeida",
    phone: "(89) 9 9411-2233",
    specialties: "Cortes clássicos, degradê navalhado e visagismo",
  ...
  },
  {
    ...
    barbershop_id: DEFAULT_BARBERSHOP_ID,
    name: "Diego Ferreira",
    phone: "(89) 9 9422-3344",
    specialties: "Barba na toalha quente, alinhamento e pigmentação",
  ...
  },
  {
    ...
    barbershop_id: DEFAULT_BARBERSHOP_ID,
    name: "Júnior Santos",
    phone: "(89) 9 9433-4455",
    specialties: "Cortes modernos, freestyle e tratamentos capilares",
...
const INITIAL_APPOINTMENTS = [
  ...
  },
  {
    ...
    service_price: 45,
    duration_minutes: 40,
    barber_id: "barb-diego",
    barber_name: "Diego Ferreira",
    date: getTodayFormatted(0),
    start_time: "10:30",
    end_time: "11:10",
    status: "confirmed",
  ...
  },
  {
    ...
    customer_phone: "(89) 9 9877-3322",
    service_id: "srv-barba",
    service_name: "Barba completa",
    service_price: 35,
    duration_minutes: 30,
    barber_id: "barb-junior",
    barber_name: "Júnior Santos",
    date: getTodayFormatted(0),
    start_time: "14:00",
    end_time: "14:30",
    status: "pending",
    notes: "Pele sensível com toalha quente.",
